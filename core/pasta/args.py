...
def get_args(cmd=False):
    ...
    parser.add_argument("--train_set", type=bool, default=True)
    ...
    parser.add_argument("--enumerate_contact", type=bool, default=False)
    ...
    parser.add_argument("--vae_type", type=str, default='pointflow', choices=['pointflow'])
    ...
    parser.add_argument("--actor_batch_size", type=int, default=10)
    ...
    parser.add_argument("--eval_plan", type=bool, default=False)
    parser.add_argument("--eval_skill", type=bool, default=False)
    ...
    parser.add_argument('--filter_set', type=bool, default=True)

    # Feasibility
    parser.add_argument("--fea_arch", type=str, default='v0')
    parser.add_argument("--fea_type", type=str, default='regression', help="[regression, ifea, sgld]")
    parser.add_argument("--fea_center", type=bool, default=False)
    parser.add_argument("--fea_uniform_z", type=bool, default=False)
    parser.add_argument("--t_relative", type=bool, default=False)

    # Reward
    parser.add_argument("--rew_loss", type=str, default='mse', help="[mse, huber]")
    parser.add_argument("--rew_center", type=bool, default=True)
    parser.add_argument("--rew_huberd", type=float, default=0.2)
    parser.add_argument("--balanced_reward_training", type=bool, default=True)
    ...
    parser.add_argument("--fea_z_noise", type=float, default=0.1)
    parser.add_argument("--fea_t_noise", type=float, default=0.005)
    parser.add_argument("--fea_z_noise_hard", type=float, default=0.0)
    parser.add_argument("--fea_t_noise_hard", type=float, default=0.0)
    parser.add_argument("--hard_negative_type", default=None)  # Add hard negative
    parser.add_argument("--coeff_heuristic", type=float, default=0.)
    ...
    parser.add_argument("--rhp_horizon", type=int, default=3)
    parser.add_argument("--opt_mode", type=str, default='adam')
    parser.add_argument("--gt_reward", type=bool, default=False)
    parser.add_argument("--exec_threshold", type=float, default=1e-3)
