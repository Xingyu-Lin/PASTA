...
def get_point_cnf(args):
    ...
    model = build_model(args, args.input_dim, dims, args.zdim, args.num_blocks, True).cuda(args.gpu)
...
def get_latent_cnf(args):
    ...
    model = build_model(args, args.zdim, dims, 0, args.latent_num_blocks, False).cuda(args.gpu)
