...
def add_args(parser):
    ...
    # data options
    parser.add_argument('--env_name', type=str, default="CutRearrange-v1",)
    parser.add_argument('--dataset_type', type=str, default="shapenet15k",
                        help="Dataset types.", choices=['shapenet15k', 'modelnet40_15k', 'modelnet10_15k', 'dynabs'])
    ...
    parser.add_argument('--data_dirs', type=str, nargs='+', default=[],
    ...
    parser.add_argument('--cached_state_path', type=str, default=None)
    parser.add_argument('--load_set_from_buffer', type=bool, default=False)
