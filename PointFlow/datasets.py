...
def get_datasets(args):
    if args.dataset_type == 'shapenet15k':
        ...
        args.seed = 0
        args.img_mode = 'rgb'
        args.dbscan_eps = 0.03
        args.dbscan_min_samples = 6
        args.dbscan_min_points = 10
        args.split = 'train'
        tr_dataset = PointFlowDataset(args)
        args.split = 'val'
        args.train_std = tr_dataset.stat['std']
