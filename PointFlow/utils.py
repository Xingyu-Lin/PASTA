...
# Visualization
def visualize_saved_pc(pts, gtr, idx, axis_limit, pert_order=[0, 1, 2]):
    pts = pts[:, pert_order]
    gtr = gtr[:, pert_order]
...
def visualize_point_clouds(pts, gtr, idx, dataset_type, pert_order=[0, 1, 2]):
